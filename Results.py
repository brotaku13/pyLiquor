...
class Results(QWidget):
    ...
    def populate(self, data_handler, search_args):
        # Clear data before listings.
        self.clear_tree()
        # Call on button clicked command.
        if search_args == 'wine':
    ...
    def add_item_to_cabinet(self):
        ...
        for item in liquor_to_add:
            # Prints the result of add to cabinet
            yield str(item)
